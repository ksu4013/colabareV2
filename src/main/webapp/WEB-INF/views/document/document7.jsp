						...
						<div class="block">
							...
							<form id="documentSub" method="post"  class="form-horizontal form-bordered" >
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="title"  name="title" class="form-control" placeholder="사직신청서">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										...
										<input type="hidden" id="ddocument_no" name="document_no" value="64">
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="example-text-input">사직 사유</label>
									<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="example-datepicker">사직 희망일</label>
									<div class="col-md-5">
