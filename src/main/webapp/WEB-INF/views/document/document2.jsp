							...
							<form id="documentSub" method="post"  class="form-horizontal form-bordered" >
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										...
										<input type="hidden" id="ddocument_no" name="document_no" value="41">
								...
								<div class="form-group">
								<label class="col-md-3 control-label" for="example-select">신청 사유</label>
									<div class="col-md-6">
										<select id="dcontent2" name="dcontent2" class="form-control" size="1">
											<option value="명함 신규 발급">명함 신규 발급</option>
											<option value="명함 소진에 따른 재발급">명함 소진에 따른 재발급</option>
											<option value="마케팅 등의 목적에 따른 명함 발급">마케팅 등의 목적에 따른 명함 발급</option>
										</select>
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-md-3 control-label" for="example-text-input">명함 수량</label>
									<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="example-textarea-input">명함 내용</label>
									<div class="col-md-9">
